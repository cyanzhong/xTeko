...
main.floors.MT23D = {
    "floorId": "MT23D", // 楼层唯一标识符，需要和名字完全一致
    "title": "主塔 23 层", // 楼层中文名
    "name": "23", // 显示在状态栏中的层数
    ...
    "map": [ // 地图数据，需要是13x13，建议使用地图生成器来生成
        ...
        [  3, 31,  4,247, 66,  4, 86,  4, 66,247,  4, 31,  3],
        [  3, 31,  4,  4,  4,  4,269,  4,  4,  4,  4, 31,  3],
    ...
    "events": { // 该楼的所有可能事件列表
        "6,7": {
            "trigger": "action",
            "data": [
                {"type": "changeFloor", "loc": [6,11], "floorId": "MT24"}
            ]
        }
    },
    "changeFloor": { // 楼层转换事件；该事件不能和上面的events有冲突（同位置点），否则会被覆盖
        "6,1": {"floorId": "MT22", "loc": [6,6]},
    },
