  ...
  views: [
    {
      ...
      events: {
        changed: sender => {
          const text = sender.text.toLowerCase();
          visibleItems = text.length == 0 ? symbols : symbols.filter(symbol => {
            return symbol.includes(text);
          });
          $("collection").data = map(visibleItems);
        }
      }
    },
    {
